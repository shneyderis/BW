...
function rExp(f){
  ...
  el.innerHTML=`
    ...
    <div class="cc"><h3>Деталізація <span style="font-size:8px;color:#7d8196;font-weight:400">клік → контрагенти → транзакції</span></h3><table class="tbl"><tr><th>Категорія</th><th class="r">Сума</th><th class="r">%вир</th><th class="r">${py}</th><th class="r">Δ</th></tr>
      ...
      <tr class="tot click" onclick="drillGo(${drID(dbase)})"><td>Разом OPEX</td><td class="r rd">${ff(toCur(totalE))}${c$}</td><td class="r">${revT?(totalE/revT*100).toFixed(1):"—"}%</td><td></td><td></td></tr></table></div>`;
