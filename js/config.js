...
const ROLES={
  owner:{password:"beykush2024",tabs:["balance","pl","sales","goods","exp","salary","shop","stock","cash","mkt","partners","uk","production","unrec","settings"]},
  manager:{password:"sales2024",tabs:["sales","goods","shop","stock","mkt","partners"]},
  accountant:{password:"acc2024",tabs:["balance","pl","goods","exp","cash","partners","unrec"]}
};
