...
const ROLES={
  owner:{password:"beykush2024",tabs:["balance","pl","sales","exp","shop","stock","cash","mkt","partners","uk","production","unrec","settings"]},
  manager:{password:"sales2024",tabs:["sales","shop","stock","mkt","partners"]},
  accountant:{password:"acc2024",tabs:["balance","pl","exp","cash","partners","unrec"]}
};
